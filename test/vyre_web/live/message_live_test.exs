defmodule VyreWeb.MessageLiveTest do
  use VyreWeb.ConnCase

  import Phoenix.LiveViewTest
  import Vyre.MessagesFixtures

  @create_attrs %{content: "some content", edited: true, mentions_everyone: true}
  @update_attrs %{content: "some updated content", edited: false, mentions_everyone: false}
  @invalid_attrs %{content: nil, edited: false, mentions_everyone: false}
